...
function vEval(m,p){
  ...
  ${EV.modo==='imagen'?`<div class="card">
      <div><div class="lbl">Imágenes generadas</div><div class="row"><input type="file" id="evImgs" hidden accept="image/*" multiple><button id="btnEvPick">Subir imágenes</button><span class="mute" style="font-size:12px">${EV.imgs.length?`${EV.imgs.length} adjunta(s)`:''}</span></div><div class="thumbs" id="evThumbs"></div></div>
